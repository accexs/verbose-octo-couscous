...
const CharacterCard: React.FC<CharacterCardProps> = ({
  ...
  return (
    <div className={"group flex flex-col items-center h-full relative"}>
      <Favorite id={character._id}/>
        <div
          className={
            "card card-side w-full bg-base-100 shadow-xl h-full transition-all duration-300 group-hover:border-warning border-2"
          }
        >
          <figure>
            <Image
